...
<!-- <script>
  function calculerMontant() {
    var heureTravail = parseFloat(document.getElementById('heureTravail').value);
    var cjm = parseFloat(document.getElementById('cjm').value);
    var montant = heureTravail * cjm;
